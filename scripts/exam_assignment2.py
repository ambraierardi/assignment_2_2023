...
from assignment_2_2023.srv import Left_dist, Left_distResponse
...
def cb(msg):
	global min_dist
	min_dist=min(min(msg.ranges[576:719]), 10)


def service_callback(msg):
	return Left_distResponse(min_dist)
...
def main():
    ...
    rospy.Service("/left_obst_dist", Left_dist, service_callback)
    rospy.Subscriber("/reaching_goal/feedback", PlanningActionFeedback, sub_cb)
